...
// This approach uses queue to insert element in tree structure, the proble is TC and SC
// Both are O(N);
// class TreeNode{
//     int data;
//     TreeNode left;
