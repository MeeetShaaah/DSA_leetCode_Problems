...
class Solution
{
    ...
    public ArrayList <Integer> bottomView(Node root)
    {
        ...
        // Use a TreeMap to automatically sort by horizontal distance (hd)
        ...
        while (!queue.isEmpty()) {
            ...
            // Update the hdMap with the current node's data for this hd
            hdMap.put(hd, node.data); // Use 'node.data' instead of 'node.val'
        ...
        // Extract values from the TreeMap in sorted order of hd
